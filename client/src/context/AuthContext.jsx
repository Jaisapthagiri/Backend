...
export const AuthProvider = ({ children }) => {
    ...
    // MESSAGES (optional)
    // -------------------------
    const [users, setUsers] = useState([]);           // Users for sidebar
    ...
    const fetchUsers = async () => {
        try {
            ...
            setUsers(data.users);
            setUnseenMessageCount(data.unseenMessage || {});
        } catch (err) {
            console.error(err);
    ...
    return (
        <AuthContext.Provider
            value={{
                ...
                users, selectedUser, messages, unseenMessageCount, loadingUsers, loadingMessages, fetchUsers, selectUser,
                fetchMessages, sendMessage, markMessagesAsSeen,
            }}
        >
            {children}
        </AuthContext.Provider>
